...
def import_csv():
  ...
  # prescriptions = pd.read_csv("C:/Users/kera_/Documents/GitHub/EHRTeam/Data/mimic_prescriptions.csv")
  diagnoses_icd = pd.read_csv("/Users/kera_/Documents/GitHub/EHRTeam/Data/mimic_diagnoses_icd.csv")
  d_diagnoses_icd = pd.read_csv("/Users/kera_/Documents/GitHub/EHRTeam/Data/mimic_d_diagnoses_icd.csv")
  admissions = pd.read_csv("/Users/kera_/Documents/GitHub/EHRTeam/Data/mimic_admissions.csv")
  drgcodes = pd.read_csv("/Users/kera_/Documents/GitHub/EHRTeam/Data/mimic_drgcodes.csv")
  procedures_icd = pd.read_csv("/Users/kera_/Documents/GitHub/EHRTeam/Data/mimic_procedures_icd.csv")
  d_procedures_icd = pd.read_csv("/Users/kera_/Documents/GitHub/EHRTeam/Data/mimic_d_procedures_icd.csv")

  #Import salmonella trigger codes
  salmonellaTC = pd.read_csv("/Users/kera_/Documents/GitHub/EHRTeam/Data/salmonellaRCTC.csv")
  return diagnoses_icd, d_diagnoses_icd, admissions, drgcodes, procedures_icd, d_procedures_icd, salmonellaTC
...
def preprocess_admission():
  diagnoses_icd, d_diagnoses_icd, admissions, drgcodes, procedures_icd, d_procedures_icd, _ = import_csv()

  #make a copy of admissions
  admissions2 = admissions.copy()

  #Code Addition - Kevin
  admissions2['admittime'] = pd.to_datetime(admissions2['admittime'])
  admissions2['dischtime'] = pd.to_datetime(admissions2['dischtime'])
...
"""
def merge_dataframe(admissions2):
  diagnoses_icd, d_diagnoses_icd, admissions, drgcodes, procedures_icd, d_procedures_icd, salmonellaTC = import_csv()

  #Select only ICD-9 codes from Salmonella trigger code
  salmonellaICD = salmonellaTC[salmonellaTC.CodeSystem=='ICD9CM']

  #Merge diagnoses with its definitions
  merge_diagnoses = pd.merge(diagnoses_icd.drop(columns=['Unnamed: 0']), d_diagnoses_icd.drop(columns=['Unnamed: 0']), how='inner', left_on='icd9_code', right_on='icd9_code')

  #Merge procedures with its definitions
  merge_procedures = pd.merge(procedures_icd.drop(columns=['Unnamed: 0']), d_procedures_icd.drop(columns=['Unnamed: 0']), how='inner', left_on='icd9_code', right_on='icd9_code')
  ...
  merge_salm_admit = pd.merge(merge_diag_proc_salm, admissions2.drop(columns=['Unnamed: 0'])
                                 , how='left', left_on=['subject_id', 'hadm_id']
                                 , right_on=['subject_id', 'hadm_id'])
...
if __name__ == "__main__":
  admissions2 = preprocess_admission()
  merge_(admissions2)
